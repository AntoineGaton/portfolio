...
const calculateNextPosition = (index: number) => {
  ...
  return {
    ...
    width: '800px',  // Default width for other windows
    height: '600px'  // Default height for other windows
  };
};
...
export function Desktop() {
  ...
  const desktopIcons: DesktopIcon[] = [
    { id: "aboutme", icon: User2, label: "About Me" },
  ...
  return (
    <div className="min-h-screen p-4">
      ...
      {openWindows.map((window) => (
        ...
        >
          {/* Window Contents */}
          {window.id === "aboutme" && <AboutContent />}
