...
import { Monitor, Mail, Folder, Terminal, Github, Chrome, Wifi, Battery, Sun, Search, User2, Code2, Briefcase, FileText, Gamepad2, ChevronUp, Volume2, AppWindow } from "lucide-react";
...
export function Taskbar({ openWindows = [], onWindowRestore }: TaskbarProps) {
  ...
  return (
    <>
      <div 
        className="fixed bottom-0 left-0 right-0 h-12 bg-black border-t border-black-500/30"
        style={{ zIndex: 50 }}
      >
        <div className="flex items-center justify-between h-full px-2">
          ...
          <div className="flex items-center gap-1">
            ...
            <Button 
              ...
              asChild
            >
              <a href="/docs/Antoine_Gaton_Resume-10.10.24.pdf" download>
