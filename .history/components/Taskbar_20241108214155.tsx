...
import { Monitor, Mail, Folder, Terminal, Github, Chrome, Wifi, Battery, Sun, Search, User2, Code2, Briefcase, FileText, Gamepad2, ChevronUp, Volume2, AppWindow, Maximize, Minimize2, WifiLow, WifiOff } from "lucide-react";
...
export function Taskbar({ openWindows = [], onWindowRestore }: TaskbarProps) {
  ...
  const getWifiIcon = () => {
    switch (wifiStatus) {
      ...
      case 'medium': return <Signal className="h-4 w-4" />;
