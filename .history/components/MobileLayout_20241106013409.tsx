...
export const MobileLayout = () => {
  ...
  const handleDrag = (e: React.DragEvent, id: string) => {
    ...
    // Account for padding (16px = p-4) and icon size (80px)
    const x = Math.max(16, Math.min(e.clientX - bounds.left, bounds.width - 96));
    const y = Math.max(16, Math.min(e.clientY - bounds.top, bounds.height - 96));
