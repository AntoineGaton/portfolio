          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="bg-gray-800/50 p-4 rounded-lg">
              ...
              <div className="flex flex-wrap gap-3">
                <FontAwesomeIcon icon={faPython} className="w-6 h-6" title="Python" />
                <FontAwesomeIcon icon={faJs} className="w-6 h-6" title="JavaScript" />
                <FontAwesomeIcon icon={faCode} className="w-6 h-6" title="TypeScript" />
                <FontAwesomeIcon icon={faCode} className="w-6 h-6" title="C++" />
                <FontAwesomeIcon icon={faPhp} className="w-6 h-6" title="PHP" />
                <FontAwesomeIcon icon={faHtml5} className="w-6 h-6" title="HTML" />
                <FontAwesomeIcon icon={faCss3Alt} className="w-6 h-6" title="CSS" />
            ...
            <div className="bg-gray-800/50 p-4 rounded-lg">
              ...
              <div className="flex flex-wrap gap-3">
                <FontAwesomeIcon icon={faReact} className="w-6 h-6" title="React" />
                <FontAwesomeIcon icon={faReact} className="w-6 h-6" title="Next.js" />
                <FontAwesomeIcon icon={faCode} className="w-6 h-6" title="TypeScript" />
                <FontAwesomeIcon icon={faCode} className="w-6 h-6" title="Electron" />
                <FontAwesomeIcon icon={faCss3Alt} className="w-6 h-6" title="Tailwind CSS" />
                <FontAwesomeIcon icon={faCode} className="w-6 h-6" title="Three.js" />
              </div>
            </div>
            <div className="bg-gray-800/50 p-4 rounded-lg">
