...
export function AboutContent() {
  ...
  const timelineItems: TimelineItem[] = [
    ...
    },
    {
      ...
      date: "2022 - 2024",
      description: "Worked on First Home Savings Account (FHSA), Investment Account (INVA), and tax reports related to interest and investment income from non-registered investment accounts. These projects implemented backend solutions for financial services. Contributed to cross-functional projects, collaborated with stakeholders to enhance user experience, and ensured code quality and security compliance in a regulated environment.",
    },
    {
