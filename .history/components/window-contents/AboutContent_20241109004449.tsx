...
export function AboutContent() {
  ...
  const timelineItems: TimelineItem[] = [
    ...
    },
    {
      ...
      date: "2022 - 2024",
      description: "Worked on First Home Savings Account (FHSA) and  projects and implemented backend solutions for financial services. Contributed to cross-functional projects, collaborated with stakeholders to enhance user experience, and ensured code quality and security compliance in a regulated environment.",
    },
    {
