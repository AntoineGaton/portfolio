...
import { Minus, Maximize2, X, GithubIcon, Linkedin, Twitter, Mail, Download } from "lucide-react"
      ...
      <div className="p-6 space-y-6 max-h-[calc(100vh-40px)]">
        ...
        <div className="space-y-4 text-center">
          ...
          <p className="text-gray-400 leading-relaxed">
            Driven to deliver refined solutions to complex challenges, I specialize in full-stack development with a focus on modern technologies. My experience in software development has built a solid foundation across both front-end and back-end frameworks, enabling me to approach projects with a comprehensive, well-rounded skill set.
          </p>
