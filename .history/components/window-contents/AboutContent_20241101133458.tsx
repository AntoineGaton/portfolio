...
export default function Component() {
  ...
  return (
    <div className={`bg-[#0a0a0f] text-white rounded-lg border border-gray-800 shadow-lg overflow-hidden transition-all duration-300 ${isMaximized ? 'fixed inset-0 z-50' : 'w-full max-w-3xl'}`}>
      {/* Window Title Bar */}
      <div className="flex items-center justify-between bg-[#0a0a0f] border-b border-gray-800 p-2">
        <h1 className="text-sm font-medium px-2">About</h1>
      ...
      {/* Window Content */}
      <div className="p-6 space-y-6 overflow-y-auto max-h-[calc(100vh-40px)]">
        {/* Photo Section */}
