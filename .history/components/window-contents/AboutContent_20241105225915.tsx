          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gray-800/50 p-4 rounded-lg">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <div className="relative group">
                  <FontAwesomeIcon icon={faDatabase} className="w-6 h-6" />
                  <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs bg-gray-900 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">PostgreSQL</span>
                </div>
              </div>
            </div>
            <div className="bg-gray-800/50 p-4 rounded-lg">
              ...
              <div className="flex flex-wrap gap-3">
                <div className="relative group">
                  <FontAwesomeIcon icon={faGit} className="w-6 h-6" />
                  <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs bg-gray-900 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">Git</span>
                </div>
                <div className="relative group">
                  <FontAwesomeIcon icon={faJira} className="w-6 h-6" />
                  <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs bg-gray-900 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">JIRA</span>
                </div>
                <div className="relative group">
                  <FontAwesomeIcon icon={faConfluence} className="w-6 h-6" />
                  <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs bg-gray-900 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">Confluence</span>
                </div>
                <div className="relative group">
                  <FontAwesomeIcon icon={faNetworkWired} className="w-6 h-6" />
                  <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs bg-gray-900 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">Postman</span>
                </div>
                <div className="relative group">
                  <FontAwesomeIcon icon={faDatabase} className="w-6 h-6" />
                  <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs bg-gray-900 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">MySQL Workbench</span>
                </div>
                <div className="relative group">
                  <FontAwesomeIcon icon={faDatabase} className="w-6 h-6" />
                  <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs bg-gray-900 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">MongoDB Atlas</span>
                </div>
                <div className="relative group">
                  <FontAwesomeIcon icon={faCode} className="w-6 h-6" />
                  <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs bg-gray-900 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">VSCode</span>
                </div>
                <div className="relative group">
                  <FontAwesomeIcon icon={faPython} className="w-6 h-6" />
                  <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs bg-gray-900 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">Jupyter Notebook</span>
                </div>
                <div className="relative group">
                  <FontAwesomeIcon icon={faCode} className="w-6 h-6" />
                  <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs bg-gray-900 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">Selenium</span>
                </div>
              </div>
            </div>
          </div>
