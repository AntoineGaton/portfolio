        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gray-800/50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-400">Git, Docker, AWS, JIRA, Confluence, Postman, MySQL Workbench, MongoDB Atlas, IntelliJ, VSCode, Jupyter Notebook, PyCharm, Jira, Selenium</p>
            </div>
          </div>
        </div>
