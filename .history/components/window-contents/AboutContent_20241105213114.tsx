      ...
      <div className="p-6 space-y-6 max-h-[calc(100vh-40px)]">
        ...
        <div className="space-y-4 text-center">
          ...
          <p className="text-gray-400 leading-relaxed">
            Driven by a passion for delivering refined solutions to complex challenges, I’m a full-stack developer with expertise across frontend and backend technologies, including React, Next.js, Djabgo, and MongoDB. My experience spans scalable architecture design, client-focused software solutions, and the exploration of emerging technologies, making me adaptable and forward-thinking in my approach to development.
          </p>
