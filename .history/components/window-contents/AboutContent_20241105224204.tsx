        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="bg-gray-800/50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-400">Python, JavaScript, TypeScript, C++, PHP, HTML, CSS, </p>
            </div>
            <div className="bg-gray-800/50 p-4 rounded-lg">
              <h4 className="font-medium mb-2">Frontend</h4>
              <p className="text-sm text-gray-400">React, Next.js, TypeScript, Electron, Tailwind CSS</p>
            </div>
            <div className="bg-gray-800/50 p-4 rounded-lg">
              <h4 className="font-medium mb-2">Backend</h4>
              <p className="text-sm text-gray-400">Node.js, Flask, Django, SQL</p>
            </div>
            <div className="bg-gray-800/50 p-4 rounded-lg">
