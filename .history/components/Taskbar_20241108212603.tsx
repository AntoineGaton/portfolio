...
import { Monitor, Mail, Folder, Terminal, Github, Chrome, Wifi, Battery, Sun, Search, User2, Code2, Briefcase, FileText, Gamepad2, ChevronUp, Volume2, AppWindow, Maximize } from "lucide-react";
        ...
        <div className="flex items-center justify-between h-full px-2">
          ...
          <div className="flex items-center gap-0.5">
            ...
            <div className="flex items-center">
              {/* Add fullscreen button with pulse animation */}
              <Button
                variant="ghost"
                size="icon"
